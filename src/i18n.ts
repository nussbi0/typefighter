...
const messages: Record<Locale, Messages> = {
  en: {
    ...
    event_faint: 'A faint blessing',
    event_passed: 'You walk on',
    event_buff_regen: '+2 regen',
    event_buff_focus: 'words approach 6% slower',
    event_buff_defense: '+2 defense',
    event_buff_crit: '+0.3× crit damage',
  ...
  de: {
    ...
    event_faint: 'Ein schwacher Segen',
    event_passed: 'Du gehst weiter',
    event_buff_regen: '+2 Regen',
    event_buff_focus: 'Wörter nahen 6% langsamer',
    event_buff_defense: '+2 Verteidigung',
    event_buff_crit: '+0.3× Kritschaden',
